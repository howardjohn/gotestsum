...
func startGoTest(ctx context.Context, dir string, args []string) (*proc, error) {
	...
	//cmd := exec.CommandContext(ctx, "go-fast-test", args[1:]...)
	cmd := exec.CommandContext(ctx, "/home/howardjohn/sdk/go1.21.0/bin/go-fast-test", args[1:]...)
	//cmd := exec.CommandContext(ctx, "/home/howardjohn/git/go/bin/go", args[1:]...)
	cmd.Stdin = os.Stdin
	cmd.Stderr = os.Stderr
	//cmd.Stdout = os.Stdout
	cmd.Dir = dir
	//cmd.Env = append(cmd.Env, "GOROOT=/home/howardjohn/sdk/go1.21.0")
	//cmd.Env = append(cmd.Env, "GOCACHE=/home/howardjohn/.cache/go-build")
